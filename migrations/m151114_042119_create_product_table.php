...
class m151114_042119_create_product_table extends Migration
{
    ...
    public function up()
    {
        $this->createTable('{{%product}}', [
            ...
            'shop_price' => $this->decimal(10, 2)->notNull()->defaultValue(0)->comment('商城价'),
            ...
            'on_off_datetime' => $this->integer()->comment('上架时间'),
            'view_require_credits' => $this->integer()->notNull()->defaultValue(0)->comment('查看所需积分'),
